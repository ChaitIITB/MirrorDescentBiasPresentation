...
\begin{frame}{Mirror Effects on Final Weight Distributions}
    \vspace{-0.25cm}
    \centering
    \includegraphics[width=0.9\textwidth]{../Demo/figure_weight_distributions.png}
    
    \vspace{-0.15cm}
    {\small \textbf{Geometric Signature:} $\ell_1$ induces sparsity, $\ell_{10}$ creates density. Mirror choice determines weight magnitude distribution.}
\end{frame}
